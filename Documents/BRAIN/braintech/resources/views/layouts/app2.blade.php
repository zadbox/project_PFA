...
<script>
  var swiper = new Swiper(".mySwiper", {
    ...
    autoplay: {
      delay: 0,  // Le défilement ne s'arrête jamais
      disableOnInteraction: false,  // Continue à défiler même si l'utilisateur interagit avec le slider
    },
    speed: 5000,  // Ajustez la vitesse de défilement pour un effet fluide
    breakpoints: {
      640: {
        slidesPerView: 2,
        spaceBetween: 20,
